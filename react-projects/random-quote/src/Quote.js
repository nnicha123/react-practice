...
class Quote extends Component {
    ...
    randomQuoteSelector = () => {
        let randomIndex = Math.floor(Math.random() * (this.state.quotes.length - 0)) + 0
        this.setState({ quoteSelected: this.state.quotes[randomIndex], displayQuote: true })
    }
        ...
        return (
            <div className="quoteBackground">
                <div className="quoteWrapper">
                    <svg width="600" height="300" viewBox="0 0 888 678" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="undraw_walking_outside_5ueb 1" clip-path="url(#clip0)">
                            ...
                            <path id="bird-2" d="M59.9634 35.4369L76 24.158C63.5419 22.9493 58.423 28.9241 56.3281 33.6531C46.5953 30.0993 36 34.7568 36 34.7568L68.0863 45C66.4676 41.198 63.6499 37.8807 59.9634 35.4369V35.4369Z" fill="#3F3D56" />
                            ...
                            <path id="bird-2_3" d="M601.963 24.4369L618 13.158C605.542 11.9493 600.423 17.9241 598.328 22.6531C588.595 19.0993 578 23.7568 578 23.7568L610.086 34C608.468 30.198 605.65 26.8807 601.963 24.4369V24.4369Z" fill="#3F3D56" />
                            <path id="bird-2_4" d="M785.963 106.437L802 95.158C789.542 93.9493 784.423 99.9241 782.328 104.653C772.595 101.099 762 105.757 762 105.757L794.086 116C792.468 112.198 789.65 108.881 785.963 106.437V106.437Z" fill="#3F3D56" />
                            ...
                            <g id="Girl">
                                ...
                                <path id="Polygon 1" d="M168.908 420.405C172.765 413.779 182.336 413.779 186.193 420.405L306.111 626.429C309.991 633.096 305.182 641.46 297.468 641.46H57.6329C49.9192 641.46 45.11 633.096 48.9903 626.429L168.908 420.405Z" fill="#C4C4C4" />
                                <path id="Vector_5" d="M107.361 358.344L87.8146 422.701L107.934 505.266C107.934 505.266 108.43 539.018 126.867 536.457C145.305 533.895 125.983 499.855 125.983 499.855L116.964 432.156L145.798 365.272C146.878 362.537 146.731 359.584 145.383 356.927C144.036 354.269 141.572 352.074 138.419 350.721V350.721C127.002 345.125 110.778 349.107 107.361 358.344Z" fill="#FFB9B9" />
                                ...
                                <path id="Vector_8" d="M173.202 353.961L165.82 348.036L163.975 340.63C163.975 340.63 139.985 315.449 119.686 324.336C113.343 327.114 108.621 333.507 105.127 340.986C96.2289 360.532 97.0591 382.078 107.445 401.146L139.985 462.09L213.8 456.165L200.882 417.653C200.882 417.653 213.8 393.954 189.81 377.66L173.202 353.961Z" fill="#2BB3DE" />
                                ...
                                <path id="Vector_10" d="M183.348 261.498C183.348 261.46 183.351 261.423 183.351 261.385C183.351 252.889 180.213 244.584 174.332 237.52C168.452 230.456 160.094 224.95 150.315 221.699C140.537 218.448 129.776 217.597 119.395 219.255C109.014 220.912 99.4787 225.003 91.9944 231.011C84.51 237.018 79.4132 244.672 77.3482 253.004C75.2833 261.337 76.3432 269.974 80.3936 277.823C84.4441 285.672 91.3034 292.381 100.104 297.101C108.905 301.821 119.251 304.34 129.836 304.34C131.079 304.34 135.995 311.813 137.217 311.746C137.291 289.072 155.564 263.02 183.348 261.498Z" fill="#2F2E41" />
                                <path id="Vector_11" d="M133.982 236.286C153.346 236.286 169.044 223.686 169.044 208.143C169.044 192.6 153.346 180 133.982 180C114.618 180 98.9199 192.6 98.9199 208.143C98.9199 223.686 114.618 236.286 133.982 236.286Z" fill="#2F2E41" />
                    ...
                    {this.state.displayQuote && <p className="mottoP"><i>" {this.state.quoteSelected} "</i></p>}
                    <button className="getQuoteButton" onClick={this.randomQuoteSelector}>Get your motto</button>
                </div>
            </div>
        )
    }
